...
parser.add_argument('--save_path', type=str, default='./checkpoint_so_corr', metavar='B',
...
def test(load=False):
    ...
    #Dump_text(Failure_images(target_list, y_true, y_pred), 'opda_failure_os.txt')
    ...
    #TSNE_plot(df, y_true, "opda_wos_tsne_df.png")
    Plot_confusionMatrix(y_true, y_pred, 'opda_wos_confmatrix_blues_lf.png')
